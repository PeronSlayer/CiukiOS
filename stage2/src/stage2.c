...
void stage2_main(boot_info_t *boot_info, handoff_v0_t *handoff) {
    ...
    serial_write("[ ok ] stage2 mini shell ready (help/pwd/cd/dir/type/copy/ren/move/mkdir/rmdir/attrib/del/ascii/cls/ver/echo/ticks/mem/run/ozone/shutdown/reboot)\n");
