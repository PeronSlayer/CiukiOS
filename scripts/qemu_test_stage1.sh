...
check_marker "[STREAMC-SERIAL] PASS"
check_marker_absent "[STREAMC-SERIAL] FAIL"
check_any_marker "[STAGE1-SELFTEST] DONE" "[S1T] D"

echo "[qemu-test-stage1] PASS (stage1 selftest + INT21h + COM/MZ via AH=4Bh + file I/O + findfirst/findnext + stream C marker + VGA mode13h)"
