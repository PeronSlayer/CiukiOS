...
12. Completed the next Stage1/runtime split slice by gating selftest-only code and data out of default full/full-CD Stage1 builds, recovering 527 bytes and raising full-CD free margin to 826 bytes, while preserving the selftest autorun build.
